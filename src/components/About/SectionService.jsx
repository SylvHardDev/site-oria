...
function SectionService() {
  return (
    <section className="py-12 bg-gray-100 px-4 md:px-32 text-center">
      <div className="container mx-auto">
        ...
        <div className="grid gap-2 md:grid-cols-2 lg:grid-cols-4 lg:gap-0">
          <div className="bg-blue-900 text-white p-6">
            <img
              ...
              className="w-14 h-14 my-6 mx-auto"
            />
        ...
        <div className="bg-white text-start p-4 mt-12 rounded-sm flex flex-col md:flex-row md:items-center md:justify-between border">
          <p className="my-2 text-[15px] md:w-2/3 text-gray-500">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Id ex quae
            odit eos ab, quas asperiores veritatis porro repudiandae vero at
            nesciunt.
          </p>
